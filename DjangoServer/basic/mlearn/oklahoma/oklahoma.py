...
class Oklahoma:
    ...
    def __init__(self):
        global data, save, oklahoma, my_oklahoma
        data = f"{rootpath}/data/dam/oklahoma"
        save = f"{rootpath}/save/dam/oklahoma"
        oklahoma = pd.read_csv(f'{data}/comb32.csv')
        my_oklahoma = None
    ...
    def rename_meta(self):
        my_oklahoma = oklahoma.rename(columns=oklahoma_meta)
        print(" --- 2.Features ---")
        print(my_oklahoma.columns)
